...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "quota_weight", Type: field.TypeInt, Default: 1},
		{Name: "quota_share_overflow_group_id", Type: field.TypeInt64, Nullable: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "estimated_5h_limit_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "estimated_7d_limit_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "calibration_state", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	}
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "overflowed_from_group_id", Type: field.TypeInt64, Nullable: true},
