...
func init() {
	...
	// apikeyDescQuotaWeight is the schema descriptor for quota_weight field.
	apikeyDescQuotaWeight := apikeyFields[20].Descriptor()
	// apikey.DefaultQuotaWeight holds the default value on creation for the quota_weight field.
	apikey.DefaultQuotaWeight = apikeyDescQuotaWeight.Default.(int)
	...
	// groupDescEstimated5hLimitUsd is the schema descriptor for estimated_5h_limit_usd field.
	groupDescEstimated5hLimitUsd := groupFields[31].Descriptor()
	// group.DefaultEstimated5hLimitUsd holds the default value on creation for the estimated_5h_limit_usd field.
	group.DefaultEstimated5hLimitUsd = groupDescEstimated5hLimitUsd.Default.(float64)
	// groupDescEstimated7dLimitUsd is the schema descriptor for estimated_7d_limit_usd field.
	groupDescEstimated7dLimitUsd := groupFields[32].Descriptor()
	// group.DefaultEstimated7dLimitUsd holds the default value on creation for the estimated_7d_limit_usd field.
	group.DefaultEstimated7dLimitUsd = groupDescEstimated7dLimitUsd.Default.(float64)
